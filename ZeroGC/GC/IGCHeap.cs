...
namespace ZeroGC
{
    ...
    public unsafe struct IGCHeap
    {
        ...
        public struct IGCHeapVptr
        {
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr> GetNextFinalizable;
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr, unsigned> WhichGeneration;
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr, void> SetFinalizationRun;
            public delegate* unmanaged<IGCHeap*, int, IntPtr, bool> RegisterForFinalization;
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr, bool> IsPromoted;
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr, bool> IsEphemeral;
            ...
            public delegate* unmanaged<IGCHeap*, size_t> GetCurrentObjSize;
            ...
            public delegate* unmanaged<IGCHeap*, gc_alloc_context*, size_t, uint32_t, IntPtr> Alloc;
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr, bool> IsLargeObject;
            public delegate* unmanaged<IGCHeap*, IntPtr, void> ValidateObjectMember;
            public delegate* unmanaged<IGCHeap*, IntPtr, IntPtr> NextObj;
            public delegate* unmanaged<IGCHeap*, void*, bool, IntPtr> GetContainingObject;
            public delegate* unmanaged<IGCHeap*, IntPtr, delegate* unmanaged<IntPtr, void*, bool>, void*, void> DiagWalkObject;
            public delegate* unmanaged<IGCHeap*, IntPtr, delegate* unmanaged<IntPtr, byte**, void*, bool>, void*, void> DiagWalkObject2;
            public delegate* unmanaged<IGCHeap*, delegate* unmanaged<IntPtr, void*, bool>, void*, int, bool, void> DiagWalkHeap;
            ...
            public delegate* unmanaged<IGCHeap*, delegate* unmanaged<IntPtr*, ScanContext*, uint32_t, void>, ScanContext*, void> DiagScanFinalizeQueue;
            public delegate* unmanaged<IGCHeap*, delegate* unmanaged<IntPtr*, IntPtr, uint32_t, ScanContext*, bool, void>, int, ScanContext*, void> DiagScanHandles;
            public delegate* unmanaged<IGCHeap*, delegate* unmanaged<IntPtr*, IntPtr, uint32_t, ScanContext*, bool, void>, int, ScanContext*, void> DiagScanDependentHandles;
            ...
            public delegate* unmanaged<IGCHeap*, IntPtr, bool> IsInFrozenSegment;
